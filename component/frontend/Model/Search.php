...
class Search extends Model
{
	 ...
	 */
	public function findJoomlaArticles($search, array $categories, $limit = 10)
	{
		// Initialize return
		$ret = [];
		...
		try
		{
			$ret = $db->setQuery($query, 0, $limit)->loadObjectList('', '\\Akeeba\\DocImport\\Site\\Model\\Search\\Results\\Articles');
	 ...
	 */
	public function findDocImportArticles($search, array $categories, $limit = 10)
	{
		// Initialize return
		$ret = [];
		...
		try
		{
			$ret = $db->setQuery($query, 0, $limit)->loadObjectList('', '\\Akeeba\\DocImport\\Site\\Model\\Search\\Results\\DocImportArticles');
	 ...
	 */
	public function findTickets($search, array $categories, $limit = 10)
	{
		// Initialize return
		$ret = [];
		...
		try
		{
			$ret = $db->setQuery($query, 0, $limit)->loadObjectList('', '\\Akeeba\\DocImport\\Site\\Model\\Search\\Results\\Tickets');
