...
class Com_DocimportInstallerScript extends ComAkeebaStandardInstallationLibrary
{
	public $parent = null;
	
	public function __construct() {
		$this->_akeeba_extension		= 'com_docimport';
		$this->_akeeba_install_sql_path	= 'install/install.sql';
		$this->_akeeba_script_install	= 'install.docimport.php';
		$this->_akeeba_script_update	= 'install.docimport.php';
		$this->_akeeba_script_uninstall	= 'uninstall.docimport.php';
