 ...
 */
class  Sh404sefExtpluginCom_docimport extends Sh404sefClassBaseextplugin {

  protected $_extName = 'com_docimport';
  ...
  protected function _findSefPluginPath( $nonSefVars = array()) {
    ...
    $this->_sefPluginPath =  JPATH_ROOT . '/plugins/sh404sefextplugins/com_docimport/docimport/com_docimport.php';
